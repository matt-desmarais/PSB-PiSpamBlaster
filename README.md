# PSB-PiSpamBlaster
Telephone spam silencer based on caller id. My service provider [Verizon prefixes the caller id of spam calls with SPAM?](https://www.verizon.com/about/news/block-spam-robocalls-with-verizon-new-tool)
